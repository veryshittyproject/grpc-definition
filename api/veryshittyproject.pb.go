...
var file_veryshittyproject_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x22, 0xcc, 0x01, 0x0a, 0x14, 0x4c, 0x6f, 0x67, 0x69,
...
var file_veryshittyproject_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_veryshittyproject_proto_depIdxs = []int32{
	0, // 0: LoginTelegramResponse.user:type_name -> User
	1, // 1: API.LoginTelegramDetails:input_type -> LoginTelegramDetailsRequest
	3, // 2: API.LoginTelegram:input_type -> LoginTelegramRequest
	2, // 3: API.LoginTelegramDetails:output_type -> LoginTelegramDetailsResponse
	4, // 4: API.LoginTelegram:output_type -> LoginTelegramResponse
